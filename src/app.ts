...
import { GuestUsersRoutes } from "./guestUsers/GuestRoutesConfig.js";
...
routes.push(new GuestUsersRoutes(app));
...
try {
  const databaseString = "mongodb://localhost:27017/waterLudo";
